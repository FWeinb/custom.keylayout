# My custom QWERTY `.keylayout` file for DE-style keyboards

This is an edited version of the default DE QWERTZ keyboard layout available on OS X for DE-style hardware Apple keyboards.
